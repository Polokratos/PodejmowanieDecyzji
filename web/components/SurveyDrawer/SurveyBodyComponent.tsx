...
export const SurveyBodyComponent = (props : SurveyBodyProps) : JSX.Element => {
    ...
    const mapAnswerToServer = (answer:number) => {
    ...
    const AnswerContainer = (
        <div className="drawer-body-row-sb">
            ...
            <div className="drawer-input-container">
                ...
                <input type="range" min="-8" max="8" value={answer} onChange={(e) => {setAnswer(mapAnswerToServer(Number.parseFloat(e.target.value)));}}/>
            </div>
